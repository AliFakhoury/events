...
class Event{
    ...
    /**
     * @param mixed $attenders
     */
    public function setAttenders($attenders)
    {
    ...
    /**
     * @param mixed $event_holder_ID
     */
    public function setEventHolderID($event_holder_ID)
    {
        $this->event_holder_ID = $event_holder_ID;
    }
